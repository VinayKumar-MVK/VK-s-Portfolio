      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <TiltCard
                maxTilt={8}
                glareOpacity={0.18}
                className="p-8 border-white/10 hover:border-orange-500/40 transition-colors bg-white/[0.02] backdrop-blur-sm"
              >
              ...
              {FEATURES.map((feat, idx) => {
                ...
                return (
                  <TiltCard
                    ...
                    maxTilt={10}
                    glareOpacity={0.2}
                    className="p-6 border-white/10 hover:border-orange-500/40 transition-colors bg-white/[0.02]"
                  >
            ...
            {PROJECT_DATA.gallery.length > 0 && (
              ...
              >
                <TiltCard
                  maxTilt={6}
                  glareOpacity={0.15}
                  className="p-8 border-white/10 hover:border-orange-500/30 transition-colors bg-white/[0.02]"
                >
                  <h2 className="text-xl font-black mb-5 text-white">Application Interface Screenshots</h2>
          ...
          <div className="space-y-6">
            ...
            >
              <div
                className="p-6 border-white/10 hover:border-orange-500/30 transition-colors bg-white/[0.02]"
              >
                ...
                <div className="space-y-3">
                  ...
                  <Link href="/projects">
                    <button className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-muted-foreground border border-white/10 hover:text-white hover:border-white/20 transition-all font-medium text-sm cursor-pointer">
            ...
            >
              ...
              >
                <h3 className="text-base font-bold text-white mb-4">Technologies</h3>
                <div className="flex flex-wrap gap-2">
                  {PROJECT_DATA.tech.map((t) => (
                    <span
                      key={t}
                      className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-orange-500/10 text-orange-400 border border-orange-500/20 hover:bg-orange-500/20 transition-colors"
                    >
                      {t}
                    </span>
                  ))}
