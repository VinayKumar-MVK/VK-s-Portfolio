      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <TiltCard
                maxTilt={8}
                glareOpacity={0.18}
                className="p-8 border-white/10 hover:border-emerald-500/40 transition-colors bg-white/[0.02] backdrop-blur-sm"
              >
              ...
              {DESIGN_PILLARS.map((pillar, idx) => {
                ...
                return (
                  <TiltCard
                    ...
                    maxTilt={10}
                    glareOpacity={0.2}
                    className="p-6 border-white/10 hover:border-emerald-500/40 transition-colors bg-white/[0.02]"
                  >
            ...
            {PROJECT_DATA.gallery.length > 0 && (
              ...
              >
                <TiltCard
                  maxTilt={6}
                  glareOpacity={0.15}
                  className="p-8 border-white/10 hover:border-emerald-500/30 transition-colors bg-white/[0.02]"
                >
                  <h2 className="text-xl font-black mb-5 text-white">Design Screenshots</h2>
          ...
          <div className="space-y-6">
            ...
            >
              <div
                className="p-6 border-white/10 hover:border-emerald-500/30 transition-colors bg-white/[0.02]"
              >
                <h3 className="text-base font-bold text-white mb-4">Figma Design Links</h3>
            ...
            >
              ...
              >
                <h3 className="text-base font-bold text-white mb-4">Design Tools</h3>
