...
const PROJECT_DATA = PROJECTS.find((p) => p.slug === "company-website")!;

const FEATURES = [
  {
    title: "Server-Side Rendering",
    description: "Built on Next.js App Router providing lightning-fast dynamic rendering and SEO optimization.",
    icon: Zap,
  },
  {
    title: "Real-time Inventory Tracking",
    description: "Powered by MySQL with continuous database state synchronization across modern admin dashboards.",
    icon: Database,
  },
  {
    title: "TypeScript Integration",
    description: "Fully end-to-end typed schema eliminating runtime errors and ensuring maintainability.",
    icon: Cpu,
  },
  {
    title: "Admin Dashboard",
    description: "Dedicated control panel for inventory updates, analytical reporting, and product catalog control.",
    icon: BarChart3,
  },
];

export default function CompanyWebsite() {
  const otherProjects = PROJECTS.filter((p) => p.slug !== "company-website").slice(0, 3);
  ...
  return (
    <PageWrapper>
      <style>{`
        ...
        .shimmer-text {
          background: linear-gradient(90deg, #00aacc 0%, #00d2ff 45%, #ff8c00 70%, #00aacc 100%);
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-8 mb-8 sm:mb-12 md:mb-14">
          ...
          <div className="lg:col-span-2 space-y-5 sm:space-y-8">
            ...
            >
              <TiltCard
                maxTilt={8}
                glareOpacity={0.18}
                className="p-4 sm:p-6 md:p-8 border-white/10 touch-manipulation hover:border-primary/30 transition-colors bg-white/[0.02] backdrop-blur-sm"
              >
                <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-5 flex items-center gap-2 text-white">
                  <Layers size={18} className="text-primary" /> Executive Summary & Overview
                </h2>
              ...
              {FEATURES.map((feat, idx) => {
                ...
                return (
                  <TiltCard
                    ...
                    maxTilt={10}
                    glareOpacity={0.2}
                    className="p-4 sm:p-6 border-white/10 touch-manipulation hover:border-primary/40 transition-colors bg-white/[0.02]"
                  >
            ...
            >
              ...
              >
                <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-5 flex items-center gap-2 text-white">
                  <CheckCircle2 size={18} className="text-secondary" /> Project Deliverables & Highlights
                </h2>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div
                className="p-4 sm:p-6 border-white/10 touch-manipulation hover:border-primary/30 transition-colors bg-white/[0.02]"
              >
                <h3 className="text-sm sm:text-base font-bold text-white mb-3 sm:mb-4">Project Links</h3>
                <div className="space-y-3">
                  <a
                    href="https://svrpoultryequipments.com/"
                    target="_blank"
            ...
            >
              ...
              >
                <h3 className="text-sm sm:text-base font-bold text-white mb-3 sm:mb-4">Technologies Used</h3>
                <div className="flex flex-wrap gap-2">
                  {PROJECT_DATA.tech.map((t) => (
                    <span
                      key={t}
                      className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-secondary/10 text-secondary border border-secondary/20 hover:bg-secondary/20 active:bg-secondary/20 transition-colors"
                    >
                      {t}
                    </span>
                  ))}
              ...
              >
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between items-center border-b border-white/5 pb-3">
                    ...
                    <span className="text-white font-medium">MySQL + Next API</span>
                  </div>
