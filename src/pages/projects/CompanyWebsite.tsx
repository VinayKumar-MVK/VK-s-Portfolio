      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <TiltCard
                maxTilt={8}
                glareOpacity={0.18}
                className="p-8 border-white/10 hover:border-primary/30 transition-colors bg-white/[0.02] backdrop-blur-sm"
              >
              ...
              {FEATURES.map((feat, idx) => {
                ...
                return (
                  <TiltCard
                    ...
                    maxTilt={10}
                    glareOpacity={0.2}
                    className="p-6 border-white/10 hover:border-primary/40 transition-colors bg-white/[0.02]"
                  >
          ...
          <div className="space-y-6">
            ...
            >
              <div
                className="p-6 border-white/10 hover:border-primary/30 transition-colors bg-white/[0.02]"
              >
            ...
            >
              ...
              >
                <h3 className="text-base font-bold text-white mb-4">Technologies Used</h3>
