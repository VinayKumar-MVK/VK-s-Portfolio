      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-8 mb-8 sm:mb-12 md:mb-14">
          ...
          <div className="lg:col-span-2 space-y-5 sm:space-y-8">
            ...
            >
              <TiltCard
                maxTilt={8}
                glareOpacity={0.18}
                className="p-4 sm:p-6 md:p-8 border-white/10 touch-manipulation hover:border-purple-500/40 transition-colors bg-white/[0.02] backdrop-blur-sm"
              >
              ...
              {MODULES.map((mod, idx) => {
                ...
                return (
                  <TiltCard
                    ...
                    maxTilt={10}
                    glareOpacity={0.2}
                    className="p-4 sm:p-6 border-white/10 touch-manipulation hover:border-pink-500/40 transition-colors bg-white/[0.02]"
                  >
                    ...
                    <h3 className="text-white font-bold text-sm sm:text-base mb-1.5 sm:mb-2">{mod.title}</h3>
                    <p className="text-muted-foreground text-[11px] sm:text-xs leading-relaxed">{mod.description}</p>
                  </TiltCard>
                );
              })}
            </motion.div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div
                className="p-4 sm:p-6 border-white/10 touch-manipulation hover:border-purple-500/30 transition-colors bg-white/[0.02]"
              >
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {PROJECT_DATA.tech.map((t) => (
                    <span
                      key={t}
                      className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-purple-500/10 text-purple-400 border border-purple-500/20 hover:bg-purple-500/20 active:bg-purple-500/20 transition-colors"
                    >
                      {t}
                    </span>
                  ))}
