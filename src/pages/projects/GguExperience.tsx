...
const PROJECT_DATA = PROJECTS.find((p) => p.slug === "ggu-experience")!;

const FEATURES = [
  {
    title: "Cross-Platform Flutter Engine",
    description: "Single Dart codebase delivering native 60fps performance across both Android and iOS devices.",
    icon: Smartphone,
  },
  {
    title: "Real-time Firestore Database",
    description: "Instantaneous data synchronization for campus events, notices, timetables, and user profiles.",
    icon: Flame,
  },
  {
    title: "Firebase Cloud Messaging",
    description: "Targeted push notifications alerting students about upcoming lectures, exam schedules, and university news.",
    icon: Bell,
  },
  {
    title: "Interactive Campus Map",
    description: "Location-aware interactive mapping system for department navigation, libraries, and campus facilities.",
    icon: MapPin,
  },
];

export default function GguExperience() {
  const otherProjects = PROJECTS.filter((p) => p.slug !== "ggu-experience").slice(0, 3);
              ...
              >
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 hover:bg-indigo-500/20 hover:border-indigo-500/60 transition-all font-bold text-sm"
                  >
                    <ExternalLink size={15} /> WebApp Live
                  </a>
                  <a
                    href="https://github.com/VinayKumar-MVK/GGU_Experience"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 hover:bg-indigo-500/20 hover:border-indigo-500/60 transition-all font-bold text-sm"
                  >
